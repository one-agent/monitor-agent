      ...
      <header>
        <div className="header-content">
          ...
          <div className="header-status">
            <StatusIndicator />
            <a href="https://github.com/one-agent/monitor-agent.git" target="_blank" rel="noopener noreferrer" className="github-link">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" className="github-icon">
